...
const styles = theme => ({
  ...
  metamaskIcon: {
    backgroundImage: 'url('+require('../../assets/svg/icn-metamask.svg')+')',
    width: '30px',
    height: '30px'
  },
  ledgerIcon: {
    backgroundImage: 'url('+require('../../assets/svg/icn-ledger.svg')+')',
    width: '30px',
    height: '30px'
  },
  buttonText: {
  ...
  metamask: {
    backgroundImage: 'url('+require('../../assets/svg/metamask.svg')+')',
    width: '200px',
    height: '200px'
  },
  ledger: {
