...
class Unlock extends Component {
  ...
  cancelLedger = () => {
    console.log('cancelLedger')
    this.setState({ ledgerLoading: false })
  }

  cancelMetamask = () => {
    console.log('cancelMetamask')
    this.setState({ metamaskLoading: false })
  }
...
function onConnectionClicked(currentConnector, name, setActivatingConnector, activate) {
  console.log('onConnectionClicked')
  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: (width > 650 ? 'space-between' : 'center'), alignItems: 'center' }}>
      {Object.keys(connectorsByName).map(name => {
        ...
        var display = name;
        if (name === 'MetaMask') {
          url = require('../../assets/svg/icn-metamask.svg')
        } else if (name === 'WalletConnect') {
          url = require('../../assets/svg/walletConnectIcon.svg')
        } else if (name === 'TrustWallet') {
          url = require('../../assets/png/trustWallet.png')
        } else if (name === 'Portis') {
          url = require('../../assets/png/portisIcon.png')
        } else if (name === 'Fortmatic') {
          url = require('../../assets/png/fortmaticIcon.png')
        } else if (name === 'Ledger') {
          url = require('../../assets/svg/icn-ledger.svg')
        } else if (name === 'Squarelink') {
          url = require('../../assets/png/squarelink.png')
        } else if (name === 'Trezor') {
          url = require('../../assets/png/trezor.png')
        } else if (name === 'Torus') {
          url = require('../../assets/jpg/torus.jpg')
        } else if (name === 'Authereum') {
          url = require('../../assets/svg/icn-aethereum.svg')
        } else if (name === 'WalletLink') {
          display = 'Coinbase Wallet'
          url = require('../../assets/svg/coinbaseWalletIcon.svg')
        } else if (name === 'Frame') {
          return ''
        }
