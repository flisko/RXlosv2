...
export const EXITFARM = 'EXITFARM'
...
export const GET_BALANCES_FARMING = 'GET_BALANCES_FARMING'
export const GET_BALANCES_FARMING_RETURNED = 'GET_BALANCES_FARMING_RETURNED'
export const GET_BALANCES_PERPETUAL_RETURNED = 'GET_BALANCES_PERPETUAL_RETURNED'
export const WITHDRAWFARM = 'WITHDRAWFARM'
